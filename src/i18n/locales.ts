...
export const LOCALE_META: Record<Locale, { label: string; flag: string; locales: string[] }> = {
  th: { label: "ไทย", flag: "🇹🇭", locales: ["th", "th-TH"] },
  en: { label: "English", flag: "🇬🇧", locales: ["en", "en-US", "en-GB"] },
  lo: { label: "ລາວ", flag: "🇱🇦", locales: ["lo", "lo-LA"] },
};
